...
public class GemFusionScreenTest extends AbstractGemPFScreen<GemFusionScreenHandlerTest> {
    ...
    public GemFusionScreenTest(GemFusionScreenHandlerTest handler, PlayerInventory inventory, Text title) {
