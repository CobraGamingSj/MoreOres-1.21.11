...
//
//public class GemFusionRecipe implements Recipe<GemPurifyingRecipeInput> {
...
//
//    public GemFusionRecipe(ItemStack result, Ingredient... ingredient) {
...
//                Ingredient.CODEC.fieldOf("ingredientGem").forGetter(GemFusionRecipe::getIngredient),
//                ItemStack.VALIDATED_CODEC.fieldOf("resultGem").forGetter(GemFusionRecipe::getResult)
...
//            return new GemFusionRecipe(ingredient, result);
//        }
//    }
//}
