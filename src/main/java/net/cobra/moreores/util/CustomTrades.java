...
public class CustomTrades {
    ...
    private static TradeOffer createNewOffer(Item item, int buyPrice, ItemStack stackSold, int maxUses, int merchantExperience, float priceMultiplier) {
        return new TradeOffer(new TradedItem(item, buyPrice), stackSold, maxUses, merchantExperience, priceMultiplier);
    }
}
