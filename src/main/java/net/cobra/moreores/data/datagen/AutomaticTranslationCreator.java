    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        for (Item item :  Registries.ITEM) {
            ...
            if (id.getNamespace().equals(MoreOresModInitializer.MOD_ID)) {
                ...
                item == ModItems.RADIANT_UPGRADE_SMITHING_TEMPLATE || item == ModBlocks.GEM_INFUSION_BLOCK.asItem() || item == ModBlocks.GEM_PURIFIER_BLOCK.asItem()) {
                    continue;
                }
        ...
        translationBuilder.add(ModBlocks.GEM_INFUSION_BLOCK, "Gem Infusion");
