...
public class VanillaLootTableModifier {
    private static final RegistryKey<LootTable> JUNGLE_PYRAMID_KEY = RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.ofVanilla("chests/jungle_temple"));
    private static final RegistryKey<LootTable> ABANDONED_MINESHAFT_KEY = RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.ofVanilla("chests/jungle_temple"));
    private static final RegistryKey<LootTable> PLAINS_VILLAGE_TOOLSMITH_KEY = RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.ofVanilla("chests/abandoned_mineshaft"));
        ...
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            ...
            if(ABANDONED_MINESHAFT_KEY.equals(key)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .with(ItemEntry.builder(ModItems.RADIANT_UPGRADE_SMITHING_TEMPLATE))
