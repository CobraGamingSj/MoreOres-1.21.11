...
//
//public class RadiantSwordItem extends Item {
//     static boolean isEvolved = false;
//    
//    public RadiantSwordItem(Settings settings) {
//        super(settings);
//    }
//
//    public static AttributeModifiersComponent create() {
//        return isEvolved ? AttributeModifiersComponent.builder().add(EntityAttributes.ATTACK_DAMAGE,
//                new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, 5.0, EntityAttributeModifier.Operation.ADD_VALUE),
//                AttributeModifierSlot.MAINHAND).build() : AttributeModifiersComponent.builder().add(EntityAttributes.ATTACK_DAMAGE,
...
//    }
//    
//    public static void setEvolved(boolean value) {
//        isEvolved = value;
//    }
//    
//    @Override
...
//        return isEvolved && attacker.fallDistance > 2 && !attacker.isGliding();
//    }
//
//    @Nullable
//    @Override
