...
public class ModOrePlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> placedFeatureRegisterable) {
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_RUBY_MEDIUM, registryEntry21, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
                ORE_RUBY_LARGE,
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_PINK_GARNET_MEDIUM, registryEntry33, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_GREEN_GARNET_MEDIUM, registryEntry36, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
        ...
        PlacedFeatures.register(
                ...
                List.of(
                        ...
                        RarityFilterPlacementModifier.of(5), // very rare in stone
        ...
        PlacedFeatures.register(
                ...
                List.of(
                        ...
                        RarityFilterPlacementModifier.of(5), // deepslate
                        SquarePlacementModifier.of(),
                        HeightRangePlacementModifier.trapezoid(
                                YOffset.fixed(-64),
                                YOffset.fixed(-20)
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_TOPAZ_MEDIUM, registryEntry39, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
                ORE_TOPAZ_LARGE,
                registryEntry40,
                modifiersWithRarity(5,HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-20), YOffset.aboveBottom(56)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
                ORE_WHITE_TOPAZ,
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_WHITE_TOPAZ_MEDIUM, registryEntry42,modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_PERIDOT_MEDIUM, registryEntry45, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
                ORE_PERIDOT_LARGE,
        ...
        PlacedFeatures.register(
                placedFeatureRegisterable, ORE_JADE_MEDIUM, registryEntry48, modifiersWithCount(5,HeightRangePlacementModifier.uniform(YOffset.fixed(-64), YOffset.fixed(-4)))
        );
        PlacedFeatures.register(
                placedFeatureRegisterable,
                ORE_JADE_LARGE,
