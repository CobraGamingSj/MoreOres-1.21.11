...
public class ModOreConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_GREEN_SAPPHIRE_LARGE, Feature.ORE, new OreFeatureConfig(greenSapphireList, 4, 0.696F));
        ConfiguredFeatures.register(featureRegisterable, ORE_GREEN_SAPPHIRE_MEDIUM, Feature.ORE, new OreFeatureConfig(greenSapphireList, 3, 0.57F));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_BLUE_GARNET_LARGE, Feature.ORE, new OreFeatureConfig(blueGarnetList, 4, 0.699F));
        ConfiguredFeatures.register(featureRegisterable, ORE_BLUE_GARNET_MEDIUM, Feature.ORE, new OreFeatureConfig(blueGarnetList, 3, 0.51F));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_PINK_GARNET_LARGE, Feature.ORE, new OreFeatureConfig(pinkGarnetList, 4, 0.616F));
        ConfiguredFeatures.register(featureRegisterable, ORE_PINK_GARNET_MEDIUM, Feature.ORE, new OreFeatureConfig(pinkGarnetList, 3, 0.52F));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_GREEN_GARNET_LARGE, Feature.ORE, new OreFeatureConfig(greenGarnetList, 3, 0.695F));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_TOPAZ_LARGE, Feature.ORE, new OreFeatureConfig(topazList, 3, 0.695F));
        ...
        ConfiguredFeatures.register(featureRegisterable, ORE_WHITE_TOPAZ_LARGE, Feature.ORE, new OreFeatureConfig(whiteTopazList, 4, 0.697F));
        ConfiguredFeatures.register(featureRegisterable, ORE_WHITE_TOPAZ_MEDIUM, Feature.ORE, new OreFeatureConfig(whiteTopazList, 3, 0.618F));
        ConfiguredFeatures.register(featureRegisterable, ORE_PERIDOT_SMALL, Feature.ORE, new OreFeatureConfig(peridotList, 3, 0.57F));
        ConfiguredFeatures.register(featureRegisterable, ORE_PERIDOT_LARGE, Feature.ORE, new OreFeatureConfig(peridotList, 3, 0.699F));
