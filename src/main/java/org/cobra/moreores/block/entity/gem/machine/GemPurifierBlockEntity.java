...
public class GemPurifierBlockEntity extends AbstractGemMachineBlockEntity<GemPurifierDataSynchronizer> {
    ...
    public void writeData(WriteView view) {
        ...
        view.putLong("gem_purifier.water", this.fluidStorage.amount);
        view.putNullable("gem_purifier.fluidAmount.variant", FluidVariant.CODEC, this.fluidStorage.variant);
        view.putNullable("WaterState", FluidState.CODEC, this.fluidState);
    ...
    public void readData(ReadView view) {
        super.readData(view);
        this.fluidStorage.amount = view.getLong("gem_purifier.water", 0);
        this.fluidStorage.variant = view.read("gem_purifier.fluidAmount.variant", FluidVariant.CODEC).orElse(FluidVariant.blank());
    ...
    enum FluidState implements StringIdentifiable {
        IDLE("idle"),
        FILLING("filling"),
        EMPTYING("emptying");
