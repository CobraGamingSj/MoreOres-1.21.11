...
public class GemCrystallizerBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if(world.isClient()) {
            ...
            boolean alt = InputUtil.isKeyPressed(window, InputUtil.GLFW_KEY_LEFT_ALT);
